                        ...
                        <Menu
                          ...
                          sx={{
                            "& .MuiPaper-root": {
                              ...
                              height: "175px", // Adjust the height to be more
                            },
                          }}
 
                        >
                          <MenuItem onClick={handleMenuClose} sx={{ borderBottom: "1px solid #CCCCCC", fontFamily: "inherit", }}>Completed</MenuItem>
                          <MenuItem onClick={handleMenuClose} sx={{ borderBottom: "1px solid #CCCCCC", fontFamily: "inherit", }}>Incompleted</MenuItem>
                          <MenuItem onClick={handleMenuClose} sx={{ borderBottom: "1px solid #CCCCCC", fontFamily: "inherit", }}>Learning Suspended</MenuItem>
                          <MenuItem onClick={handleMenuClose} sx={{ fontFamily: "inherit", }}>Completed with Delay</MenuItem>
  ...
  return (
    ...
    <Box
      sx={{
        ...
        minHeight: expanded ? 810 : 470, // Dynamic height based on dropdown
        backgroundColor: "#FFFFFF",
        borderRadius: "15px",
        opacity: 1,
        padding: 3,
        boxShadow: "0 4px 12px rgba(0, 0, 0, 0.1)", // optional, adds a shadow
