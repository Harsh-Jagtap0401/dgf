import {
  ...
  export default function UserTable() {
    return (
      <Box sx={{ width: "100%", overflow: "hidden", position: "absolute", width: 1350, backgroundColor: "#FFFFFF", borderRadius: "15px", opacity: 1, padding: 3, boxShadow: "0 4px 12px rgba(0, 0, 0, 0.1)", transition: "min-height 0.3s ease" }}>
